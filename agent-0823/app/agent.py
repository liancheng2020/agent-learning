...
class ReviewAgent:
    def __init__(self, retriever: KnowledgeRetriever, top_k: int = 2, version: str = "tuned") -> None:
    ...
    def review(self, diff_text: str) -> ReviewResult:
        ...
        return ReviewResult(summary=summary, findings=findings, tool_runs=tool_runs, prompt_version=f"review-{self.version}-v2")
